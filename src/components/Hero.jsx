            ...
            <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <p className="text-3xl font-bold tracking-tight text-lime-600 sm:text-4xl">
                    善为（北京）健康管理有限公司
                  </p>
                  <h1 className="text-gray-900 mt-6 text-4xl font-bold tracking-tight  sm:text-6xl">
                    您身边的健康专家
                  </h1>
                  <p className="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                    想要更全面、更细致的体检吗？赴日体检是您的不二选择！我们与日本多家医院合作，为您提供高质量的体检服务。在日本，您将获得专业的医生和设备，以及一系列全面的检查项目，从而全面发现身体的问题并及时处理。
                  </p>
                  <div className="mt-10 flex items-center gap-x-6">
                    ...
                    >
                      <span aria-hidden="true"></span>400-834-6186
                    </div>
                  </div>
                </div>
